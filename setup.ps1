...
.DESCRIPTION
    - 263 Aplicativos organizados com Ícones Oficiais e indicador nítido de Open Source (FOSS).
...
Write-Host "    263 Aplicativos • Pack PC Gamer • Otimizações & Tweaks" -ForegroundColor DarkGray
Write-Host "  ==================================================================" -ForegroundColor Cyan
Write-Host ""
...
<!-- Botão Open Source Filter -->
    ...
    <Grid Margin="20">
        ...
        <Grid Grid.Row="0" Margin="0,0,0,16">
            ...
            <StackPanel Grid.Column="0" Orientation="Horizontal" VerticalAlignment="Center" Margin="0,0,16,0">
                ...
                <StackPanel VerticalAlignment="Center">
                    ...
                    <TextBlock Text="263 Aplicativos com Ícones Oficiais • Pack PC Gamer • Otimizações &amp; Tweaks" FontSize="12.5" Foreground="{DynamicResource TextSecondary}" Margin="0,3,0,0" />
                </StackPanel>
            </StackPanel>
        ...
        <TabControl Grid.Row="1" Background="Transparent" BorderThickness="0" Name="MainTabControl">
            ...
            <!-- ABA 1: APLICATIVOS -->
            <TabItem Name="TabItemApps" Header="📦 Aplicativos (263 Softwares)">
                <Grid Margin="0,16,0,0">
                    ...
                    <Grid Grid.Row="0" Margin="0,0,0,12">
                        ...
                        <!-- Resumo Contador -->
                        <TextBlock Name="TxtAppSummary" Grid.Column="2" VerticalAlignment="Center" Foreground="{DynamicResource TextSecondary}" FontSize="12" Text="Exibindo 263 de 263 aplicativos | 0 selecionados" />
                    </Grid>
            ...
            <Border Grid.Row="1" Background="#0f111a" BorderBrush="#232838" BorderThickness="1" CornerRadius="10" Padding="16" Margin="0,0,0,20">
                <StackPanel VerticalAlignment="Center">
                    ...
                    <TextBlock TextWrapping="Wrap" FontSize="12" Foreground="#94a3b8" Margin="0,8,0,0">
                        ☕ Sua contribuição nos ajuda a manter a lista de mais de 263 softwares sempre atualizada, testar novas otimizações e continuar trazendo melhorias.
                    </TextBlock>
                </StackPanel>
            </Border>
