    ...
    <Grid Margin="20">
        ...
        <Grid Grid.Row="0" Margin="0,0,0,16">
            ...
            <StackPanel Grid.Column="0">
                ...
                <TextBlock Text="247 Aplicativos com Ícones Oficiais • Pack PC Gamer • Otimizações &amp; Tweaks do Sistema" FontSize="13" Foreground="{DynamicResource TextSecondary}" Margin="0,4,0,0" />
            </StackPanel>
