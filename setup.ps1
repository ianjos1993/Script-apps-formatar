...
.DESCRIPTION
    - 246 Aplicativos organizados com Ícones Oficiais e indicador nítido de Open Source (FOSS).
    ...
    <Grid Margin="20">
        ...
        <Grid Grid.Row="0" Margin="0,0,0,16">
            ...
            <StackPanel Grid.Column="0">
                ...
                <TextBlock Text="246 Aplicativos com Ícones Oficiais • Pack PC Gamer • Otimizações &amp; Tweaks do Sistema" FontSize="13" Foreground="{DynamicResource TextSecondary}" Margin="0,4,0,0" />
            </StackPanel>
        ...
        <TabControl Grid.Row="1" Background="Transparent" BorderThickness="0" Name="MainTabControl">
            ...
            <!-- ABA 1: APLICATIVOS -->
            <TabItem Name="TabItemApps" Header="📦 Aplicativos (246 Softwares)">
                <Grid Margin="0,16,0,0">
                    ...
                    <Grid Grid.Row="0" Margin="0,0,0,12">
                        ...
                        <!-- Resumo Contador -->
                        <TextBlock Name="TxtAppSummary" Grid.Column="2" VerticalAlignment="Center" Foreground="{DynamicResource TextSecondary}" FontSize="12" Text="Exibindo 246 de 246 aplicativos | 0 selecionados" />
                    </Grid>
...
function Update-SelectionSummary {
    ...
    if ($TabItemApps) {
        $TabItemApps.Header = if ($appCount -gt 0) { "📦 Aplicativos ($appCount selecionados)" } else { "📦 Aplicativos (246 Softwares)" }
    }
    if ($TabItemTweaks) {
