...
function Install-SelectedApps {
    ...
    foreach ($app in $selectedApps) {
        ...
        try {
            $process = Start-Process cmd.exe -ArgumentList "/c winget install --id `"$($app.Id)`" -e --silent --accept-package-agreements --accept-source-agreements --disable-interactivity" -NoNewWindow -PassThru
...
function Uninstall-SelectedApps {
    ...
    foreach ($app in $selectedApps) {
        ...
        try {
            $process = Start-Process cmd.exe -ArgumentList "/c winget uninstall --id `"$($app.Id)`" -e --silent --accept-source-agreements --disable-interactivity" -NoNewWindow -PassThru -Wait
